// Command provider-a is a MOCK AI provider used for local development.
//
...
// Endpoints:
//
//	POST /v1/chat/completions -> {"provider":"provider-a","message":"..."}
//	GET  /healthz             -> {"status":"ok","provider":"provider-a"}
package main
...
// Identity + default port for THIS mock. provider-b is identical but for these.
const (
